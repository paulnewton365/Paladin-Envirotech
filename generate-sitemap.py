...
COMPONENTS = [
    ...
    ("Chain comparison (scroll-drawn)", r'data-chain-tangle', "Explanation"),
    ("Announcement spotlight", r'Latest announcement', "Editorial"),
    ("Facility spotlight", r'Facility spotlight', "Editorial"),
